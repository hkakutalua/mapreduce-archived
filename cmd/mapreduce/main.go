...
// func main() {
// 	files := "CSV_Data_2022_11_17 2 44.csv"

// 	nodes := []Node{
// 		Node{Address: "127.0.0.1", User: "henrick"},
// 		Node{Address: "127.0.0.1", User: "henrick"},
// 		Node{Address: "127.0.0.1", User: "henrick"},
// 		Node{Address: "127.0.0.1", User: "henrick"},
// 	}
// 	mapSpec := MapSpecification{FilePath: files, M: 4}
// 	reduceSpec := ReduceSpecification{OutputFile: "out", R: 4}

// 	Start(nodes, mapSpec, reduceSpec, "wordcount.so")
// }
